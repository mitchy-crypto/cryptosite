<div class="mt-5">
    ...
    <div class="flex justify-between">
        ...
        <a onclick="$modals.show('select-coin')" class="cursor-pointer self-center text-xs text-gray-500">select coin <i class="fas fa-sort"> <div wire:loading class="self-center">
    ...
    <div class="py-3 px-2" x-data="{show:false}">
        <div class="flex flex-col">
                      ...
                      <tr>
                        ...
                        <td class="px-6 py-2 text-semibold whitespace-nowrap">
                            <div class="">
                                ...
                                <x-input wire:model.debounce.1000ms="amount" class="block py-1 w-full text-xs" type="number" name="email" :value="old('amount')" required autofocus />
                        ...
                        <td class="px-6 py-2 text-semibold whitespace-nowrap">
                            ...
                            <x-input wire:model.debounce.1000ms="walletAddress" class="block py-1 w-full text-xs" type="text" name="walletAddress" :value="old('walletAddress')" required autofocus />
            ...
            <div class="flex space-x-2 justify-end mt-3">
                <button wire:click="confirmWithdrawal" class="focus:outline-none rounded-lg text-white focus:bg-indigo-900 bg-indigo-800 px-3 text-sm"><small class="flex">continue <i class="ml-1 text-xs self-center fas fa-long-arrow-alt-right"></i></small></button>
