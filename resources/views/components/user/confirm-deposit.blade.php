        ...
        <div class="col-span-3 border p-3">
            <div class="grid grid-cols-3 gap-12">
                <div class="space-y-4 flex flex-col">
                    ...
                    <div class="flex flex-col space-y-1">
                        ...
                        <small class="font-bold text-xs" style="font-size: 0.8rem">{{$cryptoEquivalentOfDeposit}} {{$activeWallet}}</small>
                        <small class="font-bold text-xs text-blue-500 underline truncae break-words" style="font-size: 0.75rem">{{App\Models\Wallet::where('code', $activeWallet)->pluck('wallet_address')->first()}}</small>
                    </div>
                </div>
                ...
                <div class="flex flex-col space-y-4" x-data="timer(new Date().getTime() + {{$timeleft}}*60000)" x-init="init()">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="flex flex-end space-x-4">
                    <button wire:click="cancelDeposit" class="self-center font-semibold text-xs rounded border border-red-500 text-red-500 hover:bg-red-500 hover:text-white py-1 px-3">Cancel and return </button>
                    <button wire:click="storeDeposit" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none focus:ring-opacity-50 self-center font-semibold text-xs rounded bg-green-400 text-white py-1 px-3">Confirm <i class="ml-2 fas fa-long-arrow-alt-right"></i></button>
