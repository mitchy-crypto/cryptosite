<div class="flex space-x-2">
    <div class="flex flex-col">
        ...
        <small class="text-xs  {{session('confirmdeposit') ? 'text-gray-500' : 'text-green-500' }}">Step 1</small>
    </div>
    ...
    <div class="flex flex-col" >
        ...
        <small class="text-xs {{session('confirmdeposit') ? 'text-green-500' : 'text-gray-500' }}">Step 2</small>
