<div class="fixed px-8 pt-5 pb-3 w-10/12 bg-white">
        <div class="flex justify-between">
            ...
            <div class="flex space-x-2">
                <h2 class="font-semibold capitalize text-sm self-center">{{auth()->user()->name}}</h2>
                <img class="self-center h-5 w-5 rounded-full" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60" alt="">
            </div>
        </div>
</div>